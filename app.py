...
## Vector embedding and Objectbax Vectorstore DB
...
def vector_embedding():
    if "vectors" not in st.session_state:
        ...
        st.session_state.vectors = ObjectBox.from_documents(st.session_state.final_documents,st.session_state.embedding, embedding_dimensions=768)
